...
SIGNALS_DB = "C:/Users/alper/Desktop/crew-investing/server/most_ema_signals.db"
PRICES_DB  = "C:/Users/alper/Desktop/crew-investing/server/hissedata.db"
RESULTS_DB = "C:/Users/alper/Desktop/crew-investing/server/most_ema_results.db"
...
# 4) MOST EMA sinyallerini oku
conn_sig = sqlite3.connect(SIGNALS_DB)
df_signals = pd.read_sql_query(
    "SELECT symbol, signal FROM most_ema_signals",
    conn_sig
)
conn_sig.close()
...
for sig, symbols in groups.items():
    list_name = f"most_ema_{sig.lower()}"  # "most_ema_buy" veya "most_ema_sell"
...
print("✅ MOST EMA listeleri için günlük getiriler hesaplandı ve most_ema_results.db’ye kaydedildi.")
