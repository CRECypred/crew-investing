...
SIGNALS_DB = "C:/Users/alper/Desktop/crew-investing/server/most_signals.db"
PRICES_DB  = "C:/Users/alper/Desktop/crew-investing/server/hissedata.db"
RESULTS_DB = "C:/Users/alper/Desktop/crew-investing/server/most_results.db"
...
for sig, symbols in groups.items():
    list_name = f"most_{sig.lower()}"  # "most_buy" veya "most_sell"
...
print("✅ MOST listeleri için günlük getiriler hesaplandı ve most_results.db’ye kaydedildi.")
